...
public class CapersRepository {
    ...
    public static void setupPersistence() throws IOException {
        ...
        File STORY_FOLDER = join(CAPERS_FOLDER, "story.txt");
...
//        String textFile =Utils.readContentsAsString(story);
        StringBuilder textFile = new StringBuilder(Utils.readContentsAsString(story));
        textFile.append(text);
        System.out.println(textFile.toString());
        writeContents(story, textFile.toString());
    }
